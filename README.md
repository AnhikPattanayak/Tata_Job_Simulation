...
1. **Monthly Revenue Trend** — Revenue peaked at approx. $755k in November 2011; consistent growth from August through November driven by holiday demand; sharp drop in December 2011 (approx. $205k)

2. **Day-wise Revenue & Avg Spend** — Thursday leads in both total revenue (approx. $1.1M) and avg spend per customer (approx. $528); Sunday has the lowest sales volume but above-average spend per customer; no transactions recorded on Saturday

3. **Geographic Revenue (With UK)** — UK accounts for approx. 90% of total revenue (approx. $4.28M), dwarfing all other markets combined — a significant market concentration risk

4. **Geographic Revenue (Without UK)** — Germany (approx. $178k) and France (approx. $156k) are the top international markets; EIRE has the highest avg spend per customer at approx. $45,640 — likely wholesale/bulk buyers

    | Rank | Country | Total Revenue |
    | --- | --- | --- |
    | 1 | Germany | approx. $178k |
    | 2 | France | approx. $156k |
    | 3 | EIRE | approx. $136k |
    | 4 | Switzerland | approx. $40k |
    | 5 | Netherlands | approx. $30k |

5. **Customer Analysis** — CustomerID 17841 placed the most orders (7,767 transactions) but at lower avg spend; CustomerID 14911 is the highest spender overall (approx. $107k); transaction count alone is a poor proxy for customer value — total spend is the stronger signal

6. **Product Analysis** — REGENCY CAKESTAND 3 TIER leads by revenue (approx. $82,581); PACK OF 72 RETROSPOT CAKE CASES leads by units sold (14,971) — high volume, low margin; POSTAGE appears as 2nd highest revenue item (approx. $66k)
...
- **November 2011 = peak revenue (approx. $755k)** — stock and logistics planning must begin by September to capitalise on the holiday window
...
- **CustomerID 14911 (approx. $107k spend) and 14096 (approx. $53k) are true VIPs** — exclusive loyalty benefits and personal discounts should be extended to retain them
- **REGENCY CAKESTAND 3 TIER (approx. $82k revenue) must never go out of stock** — it is the single highest-revenue product in the catalogue
